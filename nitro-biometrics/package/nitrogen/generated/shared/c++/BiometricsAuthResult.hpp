...
namespace margelo::nitro::nitrobiometrics {
  ...
  /**
   * A struct which can be represented as a JavaScript object (BiometricsAuthResult).
   */
  ...
  public:
    ...
    explicit BiometricsAuthResult(bool success, std::optional<std::string> error): success(success), error(error) {}
...
namespace margelo::nitro {
  ...
  // C++ BiometricsAuthResult <> JS BiometricsAuthResult (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrobiometrics::BiometricsAuthResult> final {
    static inline margelo::nitro::nitrobiometrics::BiometricsAuthResult fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
