///
/// Variant_NullType_BiometryType.swift
 ...
 */
@frozen
public indirect enum Variant_NullType_BiometryType {
  case first(NullType)
  case second(BiometryType)
}

public extension Variant_NullType_BiometryType {
