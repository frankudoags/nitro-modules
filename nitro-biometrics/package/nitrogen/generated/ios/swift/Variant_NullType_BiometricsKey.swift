///
/// Variant_NullType_BiometricsKey.swift
 ...
 */
@frozen
public indirect enum Variant_NullType_BiometricsKey {
  case first(NullType)
  case second(BiometricsKey)
}

public extension Variant_NullType_BiometricsKey {
