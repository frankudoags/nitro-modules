...
- [`android/`](android): All your `android`-specific implementations.
  - [`build.gradle`](android/build.gradle): The gradle build file. This contains four important pieces:
    ...
    3. Adds all Nitrogen files (`apply from: '.../NitroBiometrics+autolinking.gradle'`)
  ...
  - [`CMakeLists.txt`](android/CMakeLists.txt): The CMake build file to build C++ code. This contains four important pieces:
    1. Creates a library called `NitroBiometrics` (same as in `nitro.json`)
    2. Adds all Nitrogen files (`include(.../NitroBiometrics+autolinking.cmake)`)
  ...
  - [`src/main/java/com/margelo/nitro/nitrobiometrics/`](android/src/main/java/com/margelo/nitro/nitrobiometrics/): All Kotlin implementations.
    - [`NitroBiometricsPackage.kt`](android/src/main/java/com/margelo/nitro/nitrobiometrics/NitroBiometricsPackage.kt): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.kt` file. In here, you can autolink all Kotlin HybridObjects.
...
- [`NitroBiometrics.podspec`](NitroBiometrics.podspec): The iOS podspec build file to build the iOS code. This contains three important pieces:
