...
namespace margelo::nitro::nitrofs::bridge::swift {
  ...
  // pragma MARK: std::shared_ptr<HybridFsSpec>
  /**
   * Specialized version of `std::shared_ptr<HybridFsSpec>`.
   */
  using std__shared_ptr_HybridFsSpec_ = std::shared_ptr<HybridFsSpec>;
  std::shared_ptr<HybridFsSpec> create_std__shared_ptr_HybridFsSpec_(void* NON_NULL swiftUnsafePointer) noexcept;
  void* NON_NULL get_std__shared_ptr_HybridFsSpec_(std__shared_ptr_HybridFsSpec_ cppType);
  
  // pragma MARK: std::weak_ptr<HybridFsSpec>
  using std__weak_ptr_HybridFsSpec_ = std::weak_ptr<HybridFsSpec>;
  inline std__weak_ptr_HybridFsSpec_ weakify_std__shared_ptr_HybridFsSpec_(const std::shared_ptr<HybridFsSpec>& strong) noexcept { return strong; }
