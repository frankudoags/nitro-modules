...
namespace margelo::nitro::nitrohaptics {
  ...
  public:
    struct JavaPart: public jni::JavaClass<JavaPart, JHybridObject::JavaPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrohaptics/HybridHapticsSpec;";
      std::shared_ptr<JHybridHapticsSpec> getJHybridHapticsSpec();
    };
    struct CxxPart: public jni::HybridClass<CxxPart, JHybridObject::CxxPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrohaptics/HybridHapticsSpec$CxxPart;";
