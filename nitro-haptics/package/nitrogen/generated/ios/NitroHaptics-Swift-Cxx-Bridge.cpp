...
namespace margelo::nitro::nitrohaptics::bridge::swift {
  ...
  std::shared_ptr<HybridHapticsSpec> create_std__shared_ptr_HybridHapticsSpec_(void* NON_NULL swiftUnsafePointer) noexcept {
    ...
    return std::make_shared<margelo::nitro::nitrohaptics::HybridHapticsSpecSwift>(swiftPart);
  }
  void* NON_NULL get_std__shared_ptr_HybridHapticsSpec_(std__shared_ptr_HybridHapticsSpec_ cppType) {
    std::shared_ptr<margelo::nitro::nitrohaptics::HybridHapticsSpecSwift> swiftWrapper = std::dynamic_pointer_cast<margelo::nitro::nitrohaptics::HybridHapticsSpecSwift>(cppType);
    #ifdef NITRO_DEBUG
